...
set autoread                    " If the file has been changed outside of vim, read it again
...
set nobomb                      " Remove UTF8 B Remove UTF8 BOM
...
let g:gist_open_browser_after_post = 1  " Let vim-gist open browser after posting a Gist 
let g:gist_show_privates = 1            " Let vim-gist show private Gist when using ':Gist -l'
let g:Powerline_symbols = "fancy"       " Fancy powerline symbols
let g:tagbar_sort = 0                   " Do not sort tags by their name
